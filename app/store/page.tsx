  ...
  return (
    <div>
      <div style={{position:'relative',padding:'60px 20px',textAlign:'center',borderBottom:'1px solid var(--glass-border)',overflow:'hidden',background:'var(--bg-2)'}}>
        <div style={{position:'absolute',left:'4%',bottom:16,zIndex:1}} className="mascot-hide-md">
          <Mascot src="/mascot/maskot-happy-belanja-bawa-tas.png" size={190} alt="Happy Belanja" />
        </div>
