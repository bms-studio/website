      ...
      html: `
        <div style="background:#0f0f13;color:#e4e4e7;font-family:Arial,sans-serif;padding:32px;max-width:480px;margin:0 auto">
          <div style="text-align:center;margin-bottom:24px">
            <h1 style="color:#e6e3dc;font-size:24px;margin:0">BMS STUDIO</h1>
          ...
          <div style="background:#1a1a2e;border-radius:12px;padding:24px;border:1px solid rgba(255,255,255,0.08)">
            ...
            <div style="background:#0f0f13;border-radius:8px;padding:16px;text-align:center;font-size:32px;font-weight:700;letter-spacing:8px;color:#e6e3dc;font-family:monospace">${otp}</div>
...
async function sendResetPasswordEmail(to, otp) {
  ...
  try {
    ...
    await t.sendMail({
      from: process.env.SMTP_FROM || 'noreply@bmsstudio.com',
      to,
      subject: 'Reset Password - BMS Platform',
      html: `
        <div style="background:#0f0f13;color:#e4e4e7;font-family:Arial,sans-serif;padding:32px;max-width:480px;margin:0 auto">
          <div style="text-align:center;margin-bottom:24px">
            <h1 style="color:#e6e3dc;font-size:24px;margin:0">BMS PLATFORM</h1>
            <p style="color:#9ca3af;font-size:13px">Reset Password</p>
          </div>
          <div style="background:#1a1a2e;border-radius:12px;padding:24px;border:1px solid rgba(255,255,255,0.08)">
            <p style="margin:0 0 16px;font-size:14px;color:#e4e4e7">Kode verifikasi untuk reset password Anda:</p>
            <div style="background:#0f0f13;border-radius:8px;padding:16px;text-align:center;font-size:32px;font-weight:700;letter-spacing:8px;color:#e6e3dc;font-family:monospace">${otp}</div>
            <p style="margin:16px 0 0;font-size:12px;color:#6b7280">Kode berlaku 10 menit. Jika Anda tidak meminta reset, abaikan email ini.</p>
          </div>
        </div>
      `
    });
